...
public class MyTimerTask extends TimerTask
{
  ...
  public void run() {
    ...
    Point tmp74_71 = Brick.ball; tmp74_71.x = (int)(tmp74_71.x + Math.cos(Brick.alpha) * Brick.ballV);
    Point tmp97_94 = Brick.ball; tmp97_94.y = (int)(tmp97_94.y + Math.sin(Brick.alpha) * Brick.ballV);

    if ((Brick.ball.x < 0) || (Brick.ball.x > Brick.feldBreite)) {
      Brick.alpha = 3.141592653589793D - Brick.alpha;
      Point tmp151_148 = Brick.ball; tmp151_148.x = (int)(tmp151_148.x + Math.cos(Brick.alpha) * Brick.ballV);
      Point tmp174_171 = Brick.ball; tmp174_171.y = (int)(tmp174_171.y + Math.sin(Brick.alpha) * Brick.ballV);
    }
